...
import (
    ...
    jobHandlers "github.com/equinor/radix-job-scheduler-server/api/handlers/jobs"
    jobHandlersTest "github.com/equinor/radix-job-scheduler-server/api/handlers/jobs/mock"
...
func setupTest(jobHandler jobHandlers.Handler) *testutils.ControllerTestUtils {
    jobController := jobController{model: jobHandler}
