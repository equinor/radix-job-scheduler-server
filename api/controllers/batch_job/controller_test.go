...
import (
    ...
    batchHandlers "github.com/equinor/radix-job-scheduler-server/api/handlers/batches"
    batchHandlersTest "github.com/equinor/radix-job-scheduler-server/api/handlers/batches/mock"
