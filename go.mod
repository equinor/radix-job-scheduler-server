...
require (
	...
	github.com/equinor/radix-job-scheduler v1.4.1
	github.com/equinor/radix-operator v1.19.0
...
require (
	...
	github.com/prometheus-operator/prometheus-operator v0.44.0 // indirect
