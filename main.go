...
import (
    ...
    controllers "github.com/equinor/radix-job-scheduler-server/api/controllers/job"
    ...
    jobModels "github.com/equinor/radix-job-scheduler/models/jobs"
...
func getControllers(env *schedulerModels.Env) []models.Controller {
    ...
    return []models.Controller{
        controllers.New(jobModels.New(env, kubeUtil, kubeClient, radixClient)),
    }
}
